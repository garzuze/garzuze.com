                ...
                <div className="items-end w-full h-1/2 border-t border-stone-200 dark:border-stone-900">
                    <div className="w-full h-full flex items-center">
                        <div className="w-full">
                            <h1 className="md:text-4xl text-lg sm:text-3xl font-bold sm:px-4 px-1 border-y border-stone-200 dark:border-stone-900 w-full">Lucas Garzuze Cordeiro</h1>
                            <div className="flex w-full items-center border-b border-stone-200 dark:border-stone-900">
                                <p className="sm:text-sm text-xs items-center sm:px-4 px-1 text-gray-500 dark:text-gray-300 italic">Looking for building a brighter future through technology.</p>
                            </div>
                        </div>
                    </div>
                </div>
